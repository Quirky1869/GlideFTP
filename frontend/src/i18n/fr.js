export default {
  ...
  newFolderWhereTitle: 'Où créer le nouveau dossier ?',
  newFolderCurrentDir: 'Dossier actuel',
  newFolderClickedDir: 'Dossier sélectionné',
  newFolderIn: 'Dans :',
  rename: 'Renommer',
  delete: 'Supprimer',
  upload: 'Envoyer',
  ...
  notificationSoundEnabled: 'Jouer un son quand un transfert est terminé',
